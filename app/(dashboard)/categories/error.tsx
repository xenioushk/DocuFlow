    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl border border-red-200 p-12">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-6">{error.message || "Something went wrong while fetching your categories"}</p>
          <div className="flex gap-4 justify-center">
            ...
            <Link href="/dashboard" className="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition">
              Go to Dashboard
            </Link>
          </div>
        </div>
